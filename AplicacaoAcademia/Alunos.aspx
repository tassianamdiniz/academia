...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Txt_Nome" ErrorMessage="Nome Obrigatorio" ForeColor="#CC0000">*</asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Lbl_Sobrenome" runat="server" Text="Sobrenome"></asp:Label>
            <asp:TextBox ID="Txt_Sobrenome" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Txt_Sobrenome" ErrorMessage="Sobrenome Obrigatorio" ForeColor="#CC0000">*</asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Lbl_CPF" runat="server" Text="CPF"></asp:Label>
            <asp:TextBox ID="Txt_CPF" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Txt_CPF" ErrorMessage="CPF Obrigatorio" ForeColor="#CC0000">*</asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Lbl_Altura" runat="server" Text="Altura"></asp:Label>
            <asp:TextBox ID="Txt_Altura" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Txt_Altura" ErrorMessage="Altura Obrigatorio" ForeColor="#CC0000">*</asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Lbl_Peso" runat="server" Text="Peso"></asp:Label>
            <asp:TextBox ID="Txt_Peso" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="Txt_Peso" ErrorMessage="Peso Obrigatorio" ForeColor="#CC0000">*</asp:RequiredFieldValidator>
            <br />
            <br />
